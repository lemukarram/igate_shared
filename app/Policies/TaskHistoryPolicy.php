...
class TaskHistoryPolicy
{
    ...
    {
        return $user->can('force_delete_task::history');
    }
    ...
    {
        return $user->can('force_delete_any_task::history');
    }
    ...
    {
        return $user->can('restore_task::history');
    }
    ...
    {
        return $user->can('restore_any_task::history');
    }
    ...
    {
        return $user->can('replicate_task::history');
    }
    ...
    {
        return $user->can('reorder_task::history');
    }
}
