...
<div class="max-w-2xl w-full bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
    <div class="mb-8">
        <div class="flex items-center justify-between mb-4">
            <h2 class="text-2xl font-normal text-gray-900">Step 1: Business Details</h2>
            <span class="text-sm font-normal text-blue-600 bg-blue-50 px-3 py-1 rounded-full">Step 1 of 3</span>
        </div>
    ...
    <form action="{{ route('provider.onboarding.step1.post') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        <div>
            <label class="block text-sm font-normal text-gray-700 mb-2">Company Name</label>
        ...
        <div>
            <label class="block text-sm font-normal text-gray-700 mb-2">Brief Bio / Description</label>
        ...
        <div>
            <label class="block text-sm font-normal text-gray-700 mb-2">Company Logo</label>
            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-200 border-dashed rounded-xl hover:border-blue-400 transition-colors cursor-pointer bg-gray-50">
                <div class="space-y-1 text-center">
                    ...
                    <div class="flex text-sm text-gray-600">
                        <label for="file-upload" class="relative cursor-pointer bg-white rounded-md font-normal text-blue-600 hover:text-blue-500">
        ...
        <div class="pt-4">
            <button type="submit" class="w-full py-4 bg-blue-600 text-white rounded-xl font-normal hover:bg-blue-700 transition-all shadow-lg shadow-blue-100 flex items-center justify-center space-x-2">
